...
final class GradientLoadView: UIView {
    ...
    private func setupShimmer() {
        gradientLayer.colors = GradientLoadView.shimmerColors.map { $0.cgColor }
        gradientLayer.startPoint = GradientLoadView.shimmerStartPoint
        gradientLayer.endPoint = GradientLoadView.shimmerEndPoint
    ...
    static func createShimmerView(frame: CGRect, cornerRadius: CGFloat = 0) -> GradientLoadView {
        let view = GradientLoadView(frame: frame)
